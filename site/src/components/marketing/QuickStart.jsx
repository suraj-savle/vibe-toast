    ...
    <section id="quick-start" className="py-6 px-6">
      <div className="">
        ...
        <div>
          ...
          <div className="relative rounded-xl overflow-hidden shadow-md border border-(--border)/50 max-w-xl ">
            <div className="flex items-center justify-between gap-2 px-4 py-2.5 border-b border-(--border)/20 bg-(--card)">
        ...
        Show Toast
          ...
          >
            <p className="text-xs text-gray-500 leading-relaxed">
              <span className="font-medium text-gray-600">💡 Tip:</span> Place{" "}
              <code
              ...
              once in your root component. Then call{" "}
              <code
                className="px-1 py-0.5 rounded"
                style={{ backgroundColor: "rgba(0,0,0,0.05)" }}
              >
